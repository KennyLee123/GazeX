...
if __name__ == "__main__":
    metadata_path = "../reflacx-xray-localization/1.0.0/main_data/metadata_phase_1.csv"
    ...
    df_all.to_csv("patch_metadata_enhanced_bbox_1.csv", index=False)
    ...
    for index, row in df_all.iterrows():
        ...
        cluster_bboxes = generate_enhanced_gaze_video_by_id(
            "patch_metadata_enhanced_bbox_1.csv",
            patient_id,
            eps=0.3,  
            min_samples=10,  
